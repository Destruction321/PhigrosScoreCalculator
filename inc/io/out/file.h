...
/**
 * @brief 创建文件夹�? * 
 * 考虑到solutions文件夹路径长度，自定义文件夹名称限制�?5半角字符以内
 * 
 * @param path 文件夹路�? * @return int 状�? * @retval 0 成功
 * @retval -1 失败
 */
 ...
 *
 * @param[in] song 歌曲参数
 * @param[out] status 状态码，初始�?SUCCESS，不创建文件时赋值为 FAILURE
 ...
 * @param[in] folder_path 新建方案文件夹路�? * @param[in] song 歌曲参数
 * @return char* 自定义文件夹名称
 * @retval 若为 NULL，说明用户选择不创建文�? */
 ...
 * @brief 自定义文件夹名称
 *
 * @param[in] subfolder 文件夹名称数组，获取输入失败时释�? * @return true 用户选择自定义路径；
 * @return false 用户选择不创建文�? */
...
/**
 * @brief 替换/跳过已存在文�? *
 * @param[in] subfolder 文件夹名�? * @param[in] song 歌曲参数，组成文件名
 * @return int 用户选择
 * @retval 'r' �?'R' 替换文件
 * @retval 其他�?跳过创建文件
 */
 ...
 * 
 * @param[in] file_path 文件路径
 * @param[in] subfolder 自定义文件夹名称，在这个函数里释�? */
 ...
 * @brief 自定义文件夹名称
 *
 * @param[in] subfolder 文件夹名称数组，获取输入失败时释�?
